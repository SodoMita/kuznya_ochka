...
export const DECK_CARDS: DeckCardDef[] = [
  ...
  { id: 'skill_barrage', name: 'ARTILLERY CALL', kind: 'skill', desc: '3 shells strike random hostiles for 45 damage each', cost: { fe: 0, cu: 10, si: 14 }, rar: 2, exhaust: true },
...
export const KIND_LABEL: Record<string, string> = {
  board: 'CIRCUIT BOARD', skill: 'SUBROUTINE', power: 'FIRMWARE', module: 'MODULE'
};
